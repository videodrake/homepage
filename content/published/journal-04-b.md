...
![새벽 5시 한강 자전거길에서 핸드보틀을 든 채 뛰는 러너의 측면 실루엣](/assets/journal-04-b/img-1.png)
*5시 정각. 핸드보틀, 그리고 페이스 5분 45초.*
> **핵심 요약**
>
...
![페이스·시간대·수분 세 조정이 코어 체온과 체수분 비용에 각각 어떻게 작용하는지 보여주는 다이어그램](/assets/journal-04-b/img-2.png)
*세 축. 두 비용에 닿는다.*
세 축이다 — 페이스, 시간대, 수분.
...
![여름 러닝 60분 시점 평균 심박과 체감강도를 조정 전과 후로 비교한 그룹 막대 차트](/assets/journal-04-b/img-3.png)
*한 시간 끝. 두 화면.*
...
![더위 적응이 8일에서 14일에 걸쳐 혈장량·땀 나트륨·코어 체온에 미치는 일자별 변화를 보여주는 타임라인 인포그래픽](/assets/journal-04-b/img-4.png)
*8~14일. 세 변화가 같이 누적된다.*
...
![7월부터 10월까지 더위 적응 수준이 노출과 휴식에 따라 어떻게 누적되고 잔존하는지 보여주는 라인 차트](/assets/journal-04-b/img-5.png)
*7월의 누적이 10월에 회수된다.*
...
![8월 후반 새벽 한강에서 GPS 워치를 확인하며 호흡을 정리하는 러너의 측면](/assets/journal-04-b/img-6.png)
*같은 코스. 다른 화면. 8월의 끝.*
## OUTRO
