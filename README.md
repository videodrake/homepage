...
**지금 어디에 무게중심이 있나**: **상품 상세 페이지의 우측 도킹 구매 패널**. 최근 이틀(2026-04-23 ~ 04-24)간 커밋 대부분이 이 영역을 리모델링한 작업. 홈·브랜드 페이지는 구조 완성되어 있고 추가 터치만 누적 중. (레포 자체는 2026-04-21 디자인 핸드오프에서 시작)
...
- 디자인은 `project/`에서 먼저 굳히고 → `cafe24/`로 이식하는 방식이 원칙. 단, 최근엔(특히 구매 패널 작업) cafe24/ 쪽에서 바로 iteration 하는 경우가 많아지고 있음.
...
2026-04-23 ~ 04-24 이틀간 커밋 15개 주요 마일스톤. `git log --oneline` 참고.
...
_마지막 업데이트: 2026-04-24. 본 문서가 기술하는 작업 상태 기준 커밋: `8f7058f` (Remodel buy panel CTA stack)._
